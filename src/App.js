...
let petElementArray = petList.map((animal, index) => (
  ...
  return (
    ...
    <div>
      ...
      <input value={petBreed} onChange={handleBreedInput} type="text" placeholder='Pet Breed' />
      <input value={petAge} onChange={handleAgeInput} type="text" placeholder='Pet Age' />
